...
def glia_nuclei_faces_from_mesh(
    ...
    meshes to the original mesh faces.

    Restored from commit ee336ed~1: the call site survives in
    neuron.Neuron.__init__ (neuron.py:2246), but the definition was dropped
    during refactoring. Exercised only when pipeline_products carry
    glia/nuclei meshes (e.g. via segmentation_pipeline).
    """

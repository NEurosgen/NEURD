...
- [x] **Готово (Фаза 9):** zero-ref dead-code срезан во всех 16 core-файлах (−~10.7k LOC до ~27.4k).
- [ ] **Дальше — глубокий reachability** (мёртвые взаимно-ссылающиеся кластеры): метод, корни,
  динамические хазарды и подводные камни расписаны в
  [DEAD_CODE_REACHABILITY.md](DEAD_CODE_REACHABILITY.md). Сложнее и рискованнее zero-ref.

...
(заодно снимет inflation `_rebuild_limb_frames`). ⚠️ **Fail-fast по числу floating-кусков пробовали
и ОТКАТИЛИ:** число оторванных кусков НЕ предсказывает ошибку — есть нейроны с многими кусками,
которые проходят без краша (т.е. дело в связности скелетов после стичинга, а не в количестве).
Дешёвого раннего предиктора не найдено; ошибка остаётся поздней до объёмного фикса.
